        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrailerVideoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    GameplayVideoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ScreenshotsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SteamAppId = table.Column<int>(type: "int", nullable: true),
                    IgdbId = table.Column<int>(type: "int", nullable: true),
                    RawgSlug = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    GeforceNowId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    Genres = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Platforms = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    SteamTags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MetacriticScore = table.Column<int>(type: "int", nullable: true),
                    SteamReviewScore = table.Column<int>(type: "int", nullable: true),
                    SteamReviewCount = table.Column<int>(type: "int", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    IsFreeToPlay = table.Column<bool>(type: "bit", nullable: false),
                    SteamStoreUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    OfficialWebsiteUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CurrentViewers = table.Column<int>(type: "int", nullable: false),
                    ActiveStreamsCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvgViewers = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ViewersCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StreamId1 = table.Column<int>(type: "int", nullable: true),
